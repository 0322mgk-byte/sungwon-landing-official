...
export const MAIN_COPY = "동호수배치도";              // 메인 카피 텍스트
...
export const SUB_COPY = "합리적인 동호수 배치로 쾌적한 주거환경을 제공합니다";  // 서브 카피 텍스트
...
export const LAYOUT_IMAGE_SRC = "/image100_1.1.1.png"; // 이미지 경로
export const LAYOUT_IMAGE_ALT = "동호수배치도";
