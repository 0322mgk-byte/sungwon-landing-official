...
export const MOBILE_NOTICE_SIZE = 12;               // 모바일 안내문구 크기 (px)
export const MOBILE_NOTICE_MARGIN_TOP = -19;          // 모바일 안내문구 상단 여백 (px)
...
export const MAIN_COPY = "커뮤니티";                  // 메인 카피 텍스트
...
export const SUB_COPY = "입주민을 위한 프리미엄 커뮤니티 시설을 제공합니다";  // 서브 카피 텍스트
...
// 🖼️ 커뮤니티 이미지 설정
// ============================================
export const LAYOUT_IMAGE_ENABLED = true;           // 이미지 사용 여부
export const LAYOUT_IMAGE_SRC = "/Community1.jpg";  // 이미지 경로
export const LAYOUT_IMAGE_ALT = "커뮤니티 시설";

// ============================================
// 📌 하단 안내문구 설정
// ============================================
export const NOTICE_TEXT = "※안내된 정보는 향후 사업 추진 및 인허가 단계에서 조정될 수 있으며, 참고 목적으로만 확인해 주시길 바랍니다.";
export const NOTICE_SIZE = 15;                      // 글자 크기 (px)
export const NOTICE_COLOR = "rgba(150,150,150,1)";  // 글자 색상
export const NOTICE_MARGIN_TOP = -28;               // 상단 여백 (px) - 음수로 이미지에 가깝게
