...
export const CONTENT_GAP = 90;                      // 콘텐츠 요소 간 세로 간격 (px)

// ============================================
// 📱 모바일 설정 (768px 미만)
// ============================================
export const MOBILE_CONTENT_PADDING_X = 16;         // 모바일 좌우 여백 (px)
export const MOBILE_CONTENT_GAP = 40;               // 모바일 콘텐츠 간격 (px)
...
export const MOBILE_IMAGE_GAP = 60;                 // 모바일 이미지 간격 (px)
...
export const MAIN_COPY = "타입안내";                  // 메인 카피 텍스트
...
export const SUB_COPY = "다양한 평형대의 합리적인 공간설계";  // 서브 카피 텍스트
...
export const IMAGE_GAP = 150;                       // 이미지 간격 (px)
