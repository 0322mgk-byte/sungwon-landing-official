...
// 📦 콘텐츠 컨테이너 설정
// ============================================
export const CONTENT_MAX_WIDTH = 600;               // 콘텐츠 최대 너비 (px)
...
export const MAIN_COPY = "인테리어";                  // 메인 카피 텍스트
...
export const SUB_COPY = "세련된 디자인과 실용성을 갖춘 프리미엄 인테리어";  // 서브 카피 텍스트
...
export const IMAGE_GAP = 20;                        // 이미지 간격 (px)
